...
twoRoomEmpty = [[[12, 13, 14, 17, 18, 19, 20], [10, 11, 12, 15, 16, 17, 18, 19, 20], [8, 9, 12, 13, 14, 20], [8, 9, 12, 15, 18, 19, 20], [12, 13, 14, 15, 16, 17, 18, 19, 20]], [[10, 11, 12, 13, 14, 17, 18, 19, 20], [10, 11, 12, 17, 18, 19, 20], [8, 9, 12, 20], [12, 15, 18, 19, 20], [12, 15, 16, 17, 18, 19, 20]]]

sns.set(style="whitegrid")
ax = sns.catplot(x=0, y=1, hue ="kind",data=twoRoomEmpty[0])
